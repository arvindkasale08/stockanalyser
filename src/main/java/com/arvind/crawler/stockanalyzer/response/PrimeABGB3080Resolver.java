...
@Component
@Slf4j
public class PrimeABGB3080Resolver implements Resolver {
	...
	public String getUrl() {
		return "https://www.primeabgb.com/?post_type=product&taxonomy=product_cat&s=3080";
	}
}
